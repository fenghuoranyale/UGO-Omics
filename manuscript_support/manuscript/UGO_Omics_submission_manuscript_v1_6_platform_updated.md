...
Underground organs such as rhizomes, tubers, stolons, bulbs, corms, storage roots, and root crowns enable plants to persist, store resources, regenerate after disturbance, and adapt to seasonal or stressful environments. Despite their ecological and agricultural importance, comparative molecular resources for underground-organ biology remain fragmented across species, organ types, and experimental systems. Here we present UGO-Omics, an expression-backed orthogroup resource and candidate-transfer platform for comparative underground-organ biology. UGO-Omics integrates public transcriptomes, reference annotations, organ-associated expression scoring, cross-species orthogroup inference, candidate prioritization, benchmark recovery, and an interactive GitHub Pages platform. The initial analytical core links six species spanning rhizome, tuber/stolon, and storage-root contexts, while a broader 51-species layer extends the resource across major underground-organ categories. Candidate prioritization identified conserved modules associated with cell-wall remodeling, meristem and regrowth programs, developmental transcriptional regulation, hormone-related regulation, and stress resilience. To test whether prioritized candidates could be projected beyond the original analytical core, we constructed a 9-species expanded OrthoFinder backbone by adding Beta vulgaris, Brassica rapa, and Musa acuminata. This expanded backbone contained 26,459 orthogroups, including 7,346 represented in all nine species. All eight prioritized candidate orthogroups were remapped to the expanded backbone and retained homologous members in at least one newly added broad-layer species. A conservative known-module benchmark recovered 11 of 15 curated underground-organ or storage-organ modules among prioritized candidates. The UGO-Omics web platform further provides Global Search, UGO Score Explorer, Candidate Transfer, Orthogroup Detail, Species Browser, Candidate Expansion, Benchmark Recovery, and download layers. UGO-Omics therefore provides a reusable framework for discovering, ranking, and transferring candidate modules across underground-organ systems and for generating testable hypotheses in comparative plant developmental, regenerative, and storage-organ biology.
# Introduction
...
## A functional web platform supports candidate discovery and cross-species transfer

To make UGO-Omics reusable as more than a static data supplement, we implemented the resource as a functional GitHub Pages platform powered by compact JSON layers and client-side JavaScript. The platform includes a dashboard summarizing the major analytical layers, a Global Search function across species, organ categories, candidate functions, orthogroups, and benchmark modules, and a UGO Score Explorer that displays candidate ranking components including cross-species traceability, expansion support, benchmark recovery, and annotation interpretability. A Candidate Transfer Tool allows users to select target underground-organ categories and retrieve candidate modules ranked by transfer-relevant evidence, while an Orthogroup Detail View links candidate orthogroups to expansion records, benchmark evidence, and score components.

The website also retains resource-oriented browsing functions, including Species Browser, Candidate Expansion, Benchmark Recovery, Candidate Browser, Top Orthogroups, Downloads, and a Tutorial/Example Use Case page. This structure makes UGO-Omics a candidate-discovery and candidate-transfer platform rather than only a manuscript-supporting browser. Because the site is implemented as a static resource, it can be hosted, archived, and reused without a dedicated backend server. The deployed website is available at https://fenghuoranyale.github.io/UGO-Omics/.
...
## UGO-Omics web platform implementation

The UGO-Omics website was implemented as a static GitHub Pages platform using HTML, CSS, client-side JavaScript, and compact JSON data layers. The platform does not require a dedicated backend server. JSON layers were generated for species browsing, candidate browsing, top orthogroups, candidate expansion traceability, known-module benchmark recovery, global search, UGO score exploration, candidate-transfer recommendations, and orthogroup detail views. Global Search was implemented by building a combined searchable index across species, candidate, benchmark, orthogroup, and resource records. The UGO Score Explorer displays an evidence-integration score used for candidate ranking and browsing; this score combines cross-species traceability, expansion support in newly added species, benchmark-module recovery, and annotation interpretability. The Candidate Transfer Tool ranks candidate modules for target underground-organ categories using module matching and cross-species traceability. These web-based tools are intended for candidate prioritization and hypothesis generation, not for functional validation of individual genes.

# Data and website availability

The UGO-Omics web platform is available at https://fenghuoranyale.github.io/UGO-Omics/. The source files, static website, JSON browser layers, figure source tables, orthogroup summaries, candidate expansion outputs, benchmark recovery tables, supplementary tables, and manuscript-supporting materials are available at https://github.com/fenghuoranyale/UGO-Omics. A Zenodo DOI will be added before final publication. Public RNA-seq datasets and reference genome/annotation resources used in the analysis are listed in Supplementary Tables S1 and S2. The 9-species expanded OrthoFinder summary and per-species representation are provided in Supplementary Table S6. Candidate expansion traceability and Figure 4 source data are provided in Supplementary Table S7. The curated known-module benchmark seed and recovery tables are provided in Supplementary Tables S8a and S8b. The website page, JSON-layer, and figure/source asset manifest is provided in Supplementary Table S9.
...
# Figure 6. UGO-Omics functional web platform

UGO-Omics is deployed as a static GitHub Pages platform for candidate discovery and cross-species candidate transfer in underground-organ biology. The platform includes a dashboard, Global Search, UGO Score Explorer, Candidate Transfer Tool, Orthogroup Detail View, Species Browser, Candidate Expansion, Benchmark Recovery, Candidate Browser, Top Orthogroups, Tutorial, and Downloads pages. Global Search queries species, organ categories, candidate functions, orthogroups, benchmark modules, and resource records. The UGO Score Explorer displays evidence-integration ranking components, while the Candidate Transfer Tool recommends candidate modules for target underground-organ categories. The platform is powered by static JSON layers and client-side JavaScript and is intended for candidate prioritization and hypothesis generation rather than functional validation.
