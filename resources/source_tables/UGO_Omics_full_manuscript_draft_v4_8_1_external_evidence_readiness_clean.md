...
We further evaluated whether the actionability layer recovered known regulators and gene-family representatives expected to be relevant to underground-organ development, regrowth, stress survival, developmental switching, structural remodeling, and storage metabolism. This known-regulator recovery benchmark included 14 regulator or gene-family items spanning meristem/regrowth, hormone regulation, stress resilience, developmental transcriptional regulation, cell-wall remodeling, and storage metabolism. All 14 items were recovered by the UGO known-anchor panel and calibrated actionability ranking. Eleven items were classified as Tier 1 high-actionability candidate families, two cell-wall remodeling items were classified as Tier 2 actionable candidate families, and storage metabolism was retained as a recovered future-expansion category. This result extends the category-level benchmark by showing that recurrent UGO modules can be anchored to recognizable gene-level and gene-family regulators, while preserving the interpretation that these are prioritized hypotheses rather than direct functional evidence.

As a concrete species-level example, we applied the actionability framework to an Oryza longistaminata rhizome use case. This case prioritized meristem/regrowth, hormone-regulation, developmental-transcription-factor, stress-resilience, and cell-wall-remodeling modules for rhizome initiation, elongation, underground bud activity, persistence, and post-stress regrowth. The highest-priority Oryza rhizome candidate families included KNOX/STM, WOX/WUS, LBD, auxin transport and response, gibberellin metabolism and signaling, cytokinin signaling, BRC1/TB1/MAX-related branching regulators, GRAS/DELLA/SHR-SCR regulators, MADS-box developmental regulators, stress-response transcription factors, ABA-related signaling, and cell-wall remodeling families. This case study illustrates how UGO-Omics can translate a species-specific underground-organ question into a ranked set of module-supported, known-regulator-anchored candidate-family hypotheses.

We also assessed whether the current project contained a curated independent evidence table suitable for QTL/GWAS overlap, Oryza rhizome expression-candidate recovery, or rhizome module-by-actionability enrichment. A conservative audit indicated that such a claim should not yet be made from the current files because broad text scans largely detected project-derived metadata and previously generated UGO summary tables rather than independent expression, module, or genomic-interval evidence. We therefore provide standardized input templates for future integration of curated Oryza rhizome expression/module candidates and QTL/GWAS intervals. This conservative treatment avoids overinterpreting automated text matches while defining a clear route for adding external evidence in the next UGO-Omics release.
...
## Known-regulator recovery benchmark

To evaluate whether the UGO actionability layer recovered recognizable biological regulators, we curated a known-regulator recovery panel spanning meristem/regrowth, hormone regulation, stress resilience, developmental transcriptional regulation, cell-wall remodeling, and storage metabolism. Each item was represented by a known regulator, gene family, or pathway-associated symbol group and was mapped to its expected UGO module and known-gene anchor family. Recovery was scored at two levels: presence in the UGO known-anchor panel and presence in the calibrated actionability ranking. The benchmark was used to test whether UGO modules could be translated into practical candidate-family hypotheses. It was not interpreted as direct functional evidence for individual genes in a specific species.

## Oryza rhizome actionability case study

To demonstrate practical use of the UGO actionability layer, we constructed an Oryza longistaminata rhizome case study. Oryza was selected because rhizomatous perennial rice provides a clear underground shoot-system context. Candidate families from the global UGO actionability ranking were re-weighted for rhizome relevance based on module role, known-regulator anchor, and biological interpretability. Meristem/regrowth and hormone-regulation modules were treated as primary rhizome case modules; developmental transcriptional regulation was treated as a primary regulatory module; stress resilience and cell-wall remodeling were treated as supporting modules. The resulting Oryza rhizome actionability score was used to rank candidate-family hypotheses. This case study is intended as a practical use example and does not claim direct functional evidence for individual Oryza genes.

## Conservative external evidence readiness audit

To evaluate whether independent expression/module or QTL/GWAS evidence could be integrated with the UGO actionability framework, we conducted a conservative readiness audit. Automated text scans were not treated as evidence unless they could be traced to curated external input tables with explicit gene, orthogroup, module, or genomic-coordinate fields. Because the current project files primarily contained UGO-generated metadata and summary tables, the external evidence layer was retained as a readiness framework rather than a claim of enrichment or interval overlap. Standardized input templates were generated for future Oryza rhizome expression/module candidates and QTL/GWAS interval evidence.
